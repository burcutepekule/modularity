...
save(['./local_output/BEFORE_TOL_FITTEST_CIRCUIT_CONSTRAINT_SEED_' num2str(seed) '_' num2str(sim) '.mat'])
...
save(['./local_output/BEFORE_TOL_ALL_CONSTRAINT_SEED_' num2str(seed) '.mat'])
...
%     mutationIndexVec = datasample(1:3,numOfCandidateSolutions-1,'Weights',[0.8 0.3 0.6],'Replace',true);
    ...
    save(['./local_output/AFTER_TOL_FITTEST_CIRCUIT_CONSTRAINT_SEED_' num2str(seed) '_' num2str(sim) '.mat'])
    sim = sim + 1;
end
...
save(['./local_output/AFTER_TOL_ALL_CONSTRAINT_SEED_' num2str(seed) '.mat'])
