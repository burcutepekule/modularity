function [] = runSeedSizeCGLocal(seed,mutProb,numOfGatesVec,onlyChangeConnections)
...
runSeedSizeOutputCGLocal(seed,outputMat_1,outputMat_2,numOfInputs,numOfOutputs,numOfGates,numOfCandidateSolutions,mult,preDefinedSize,freqAlternate,L,mutProb,onlyChangeConnections)
end
